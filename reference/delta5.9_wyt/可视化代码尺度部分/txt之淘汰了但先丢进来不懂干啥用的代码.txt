...
% 绘制连接point1、dian的线段
plot3([point1(1), dian(1)], [point1(2), dian(2)], [point1(3), dian(3)], 'm--', 'LineWidth', 2);

% 绘制连接point2、dian的线段
plot3([point2(1), dian(1)], [point2(2), dian(2)], [point2(3), dian(3)], 'b--', 'LineWidth', 2);

% 绘制连接point3、dian的线段
plot3([point3(1), dian(1)], [point3(2), dian(2)], [point3(3), dian(3)], 'r--', 'LineWidth', 2);
